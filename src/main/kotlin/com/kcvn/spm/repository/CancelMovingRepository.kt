...
class CancelMovingRepository(private val context: DSLContext) : SortingRepository() {
    ...
    fun save(cst: CancelSendingTransactions): String? =
        context.insertInto(
            ...
            .values(cst.sourceLocationCode, cst.destLocationCode, cst.sourcePackageCode, cst.destPackageCode, cst.poNumber, cst.qty, cst.seqNo, cst.receivingSeqNo, CommonUtils.loggedInUser() ?: Constants.SYSTEM)
