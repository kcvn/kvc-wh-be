                                    ...
                                    quantityByCalendars = planDataByProcessModel.quantityByCalendars?.map { column ->
                                        ...
                                        if (sltbMachineValueDouble != 0.0) {
                                            if (numberQuantity != null) {
                                                rate = newValue.toDouble() / numberQuantity.toDouble() *100
                                            }
                                        }
                                        val color = when {
                                        ...
                                        val valueRate = when {
                                            numberQuantity == null || numberQuantity.toInt() == 0 -> ""
                                            else -> newValue + "/" + (numberQuantity.toInt()).toString() + "\n" + (ceil(rate).toInt()).toString()
                                        }
                                        KeyValueResponse(
                                            key = column.key,
                                            value = valueRate,
