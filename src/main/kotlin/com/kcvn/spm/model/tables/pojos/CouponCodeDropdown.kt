...
data class CouponCodeDropdown(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: CouponCodeDropdown = other as CouponCodeDropdown
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        else if (this.keyValue != o.keyValue)
            return false
        if (this.label == null) {
            if (o.label != null)
                return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.keyValue == null) 0 else this.keyValue.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("CouponCodeDropdown (")
