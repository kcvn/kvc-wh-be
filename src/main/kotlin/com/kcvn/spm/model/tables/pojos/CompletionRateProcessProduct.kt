...
data class CompletionRateProcessProduct(
    var id: String? = null,
    var key: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: CompletionRateProcessProduct = other as CompletionRateProcessProduct
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun toString(): String {
        val sb = StringBuilder("CompletionRateProcessProduct (")
