...
class SyncTransAmDataService(
    ...
    private fun createModelProcess(request: SyncProcessProcedureStructureResponse): ProcessProcedureStructure {
        return ProcessProcedureStructure (
            ...
            stageCode = request.KOTEI_CD,
            stageSequence = request.KOTEI_NO,
            stageSequenceRev = request.KOTEI_TEJUN_REV,
            ...
            stageType = request.KOTEI_SHUBETSU,
            displayStageSequence = request.KOTEI_HYOJI_JUN,
            ...
            registerBy = request.TOROKUSHA,
            registerDate = request.TOROKU_DATE,
            updateBy = request.KOSHINSHA,
            updateDate = request.KOSHIN_DATE,
