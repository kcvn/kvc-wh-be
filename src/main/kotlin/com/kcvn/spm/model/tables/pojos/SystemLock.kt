...
data class SystemLock(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: SystemLock = other as SystemLock
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.isLock == null) 0 else this.isLock.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("SystemLock (")
