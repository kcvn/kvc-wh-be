...
data class TempSendingTransactions(
    var id: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: TempSendingTransactions = other as TempSendingTransactions
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        if (this.isCanceled == null) {
            ...
            return false
        if (this.notMinusBoxQty == null) {
            if (o.notMinusBoxQty != null)
                return false
        }
    ...
    override fun toString(): String {
        val sb = StringBuilder("TempSendingTransactions (")
