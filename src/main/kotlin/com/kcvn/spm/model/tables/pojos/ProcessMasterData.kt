...
data class ProcessMasterData(
    ...
    var groupProcessCode: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: ProcessMasterData = other as ProcessMasterData
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        if (this.processCode == null) {
            ...
            return false
        if (this.groupProcessCode == null) {
            if (o.groupProcessCode != null)
                return false
        }
        else if (this.groupProcessCode != o.groupProcessCode)
            return false
        if (this.type == null) {
            if (o.type != null)
                return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.groupProcessCode == null) 0 else this.groupProcessCode.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("ProcessMasterData (")

        sb.append(id)
        sb.append(", ").append(processCode)
        sb.append(", ").append(groupProcessCode)
