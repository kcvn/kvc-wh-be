...
data class HolidaysCalendar(
    var id: String? = null,
    var dayOff: OffsetDateTime? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: HolidaysCalendar = other as HolidaysCalendar
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.dayOff == null) 0 else this.dayOff.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("HolidaysCalendar (")

        sb.append(id)
        sb.append(", ").append(dayOff)
