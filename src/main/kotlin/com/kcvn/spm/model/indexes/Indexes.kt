...
val IDX_UNIQUE_PRODUCT_PROCESS: Index = Internal.createIndex(DSL.name("idx_unique_product_process"), ProductProcess.PRODUCT_PROCESS, arrayOf(ProductProcess.PRODUCT_PROCESS.PRODUCT_NAME, ProductProcess.PRODUCT_PROCESS.PROCESS_CODE, ProductProcess.PRODUCT_PROCESS.LAYER_CODE), true)
