...
data class AuthUserClaim(
    var id: String? = null,
    var userId: String? = null,
    var claimType: String? = null,
    var claimValue: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: AuthUserClaim = other as AuthUserClaim
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        else if (this.claimType != o.claimType)
            return false
        if (this.claimValue == null) {
            if (o.claimValue != null)
                return false
        }
        else if (this.claimValue != o.claimValue)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.claimType == null) 0 else this.claimType.hashCode())
        result = prime * result + (if (this.claimValue == null) 0 else this.claimValue.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("AuthUserClaim (")

        sb.append(id)
        sb.append(", ").append(userId)
        sb.append(", ").append(claimType)
        sb.append(", ").append(claimValue)
