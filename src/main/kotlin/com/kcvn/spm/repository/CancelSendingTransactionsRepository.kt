...
@Repository
class CancelSendingTransactionsRepository(private val context: DSLContext) : SortingRepository() {
    companion object {
    ...
    fun save(cst: CancelSendingTransactions): String? =
        context.insertInto(
            ...
            CANCEL_SENDING_TRANSACTIONS.SOURCE_PACKAGE_CODE, CANCEL_SENDING_TRANSACTIONS.DEST_PACKAGE_CODE,
            CANCEL_SENDING_TRANSACTIONS.PO_NUMBER, CANCEL_SENDING_TRANSACTIONS.QTY, CANCEL_SENDING_TRANSACTIONS.SEQ_NO, CANCEL_SENDING_TRANSACTIONS.CREATED_BY)
            .values(cst.sourceLocationCode, cst.destLocationCode, cst.sourcePackageCode, cst.destPackageCode, cst.poNumber, cst.qty, cst.seqNo, CommonUtils.loggedInUser() ?: Constants.SYSTEM)
