...
data class ReceivingChecking(
    ...
    var seqNo: Int? = null,
    var orderBacklogId: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: ReceivingChecking = other as ReceivingChecking
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        else if (this.invoiceNo != o.invoiceNo)
            return false
        if (this.lotNo == null) {
            if (o.lotNo != null)
                return false
        ...
        if (this.seqNo == null) {
            ...
            return false
        if (this.orderBacklogId == null) {
            if (o.orderBacklogId != null)
                return false
        }
        else if (this.orderBacklogId != o.orderBacklogId)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.invoiceNo == null) 0 else this.invoiceNo.hashCode())
        ...
        result = prime * result + (if (this.orderBacklogId == null) 0 else this.orderBacklogId.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("ReceivingChecking (")
        ...
        sb.append(", ").append(orderBacklogId)
