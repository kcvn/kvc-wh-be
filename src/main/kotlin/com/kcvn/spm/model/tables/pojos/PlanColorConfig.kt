...
data class PlanColorConfig(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: PlanColorConfig = other as PlanColorConfig
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.index == null) 0 else this.index.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("PlanColorConfig (")
