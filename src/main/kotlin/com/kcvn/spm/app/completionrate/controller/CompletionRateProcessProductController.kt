...
class CompletionRateProcessProductController {

    @RestController
    @RequestMapping("/api/completion-rate/process-product")
    class CompletionRateProductProcessController (private val completionRateProcessProductService: CompletionRateProcessProductService) {
