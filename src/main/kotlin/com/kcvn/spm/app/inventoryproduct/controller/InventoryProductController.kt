...
import com.kcvn.spm.common.helper.DateTimeHelper.Companion.convertOffSetDateTime
...
class InventoryProductController(
    ...
    fun checkInventoryDate(date: OffsetDateTime
        ...
        val formattedDate = convertOffSetDateTime(date) // Định dạng lại LocalDate thành chuỗi
