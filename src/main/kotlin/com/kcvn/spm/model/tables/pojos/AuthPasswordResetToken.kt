...
data class AuthPasswordResetToken(
    var id: String? = null,
    var userId: String? = null,
    var token: String? = null,
    var expiredDate: OffsetDateTime? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: AuthPasswordResetToken = other as AuthPasswordResetToken
        if (this.id == null) {
            if (o.id != null)
                return false
        }
        ...
        else if (this.expiredDate != o.expiredDate)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.expiredDate == null) 0 else this.expiredDate.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("AuthPasswordResetToken (")
