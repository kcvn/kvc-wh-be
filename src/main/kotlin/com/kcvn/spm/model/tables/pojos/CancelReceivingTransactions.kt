...
data class CancelReceivingTransactions(
    var id: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: CancelReceivingTransactions = other as CancelReceivingTransactions
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun toString(): String {
        val sb = StringBuilder("CancelReceivingTransactions (")
