...
data class TempSendingCheckingTransactions(
    var id: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: TempSendingCheckingTransactions = other as TempSendingCheckingTransactions
        if (this.id == null) {
            if (o.id != null)
                return false
        }
    ...
    override fun toString(): String {
        val sb = StringBuilder("TempSendingCheckingTransactions (")
